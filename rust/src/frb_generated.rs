...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__simple__get_card_count_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__simple__get_card_count_from_deck_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__api__simple__get_deck_note_impl(port, ptr, rust_vec_len, data_len),
